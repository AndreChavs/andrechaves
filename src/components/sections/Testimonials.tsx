  ...
  const testimonials = [
    {
      ...
      text: 'O André é um verdadeiro especialista em automação de atendimento. Sua abordagem estratégica e sua habilidade técnica foram fundamentais para o sucesso de nossa iniciativa de automação na XYZ Tecnologia. Ele desenvolveu fluxos de chatbot personalizados que melhoraram significativamente a eficiência de nosso atendimento ao cliente, além de aumentar a satisfação do cliente. Se você está buscando otimizar seu atendimento, não procure mais do que o André Chaves.',
